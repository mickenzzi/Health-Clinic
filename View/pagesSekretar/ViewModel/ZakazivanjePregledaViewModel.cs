...
{
    public class ZakazivanjePregledaViewModel : BindableBase
    {
        ...
        public ZakazivanjePregledaViewModel(SekretarView parent,string jmbg) 
        {
            this.parent = parent;
            this.jmbg = jmbg;
            LoadLekari();
            ZakaziPregledCommand = new MyICommand(OnZakazi);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (soba != null)
                                {
                                    ...
                                    TerminiController.Instance.ZakaziPregled(termin);
