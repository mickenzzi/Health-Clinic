...
{
    class PomeranjeOperacijeViewModel : BindableBase
    {
        ...
        public PomeranjeOperacijeViewModel(SekretarView parent, string jmbg, int idTermina)
        {
            this.parent = parent;
            this.jmbg = jmbg;
        ...
        private void OnPomeri()
        {
            ...
            if (provera1 == true && provera2==true)
            {
...

                {
                    ...
                    MessageBox.Show("Nije moguce pomeranje termina unutar istog dana.");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string poruka;
                        poruka = "Pomerili ste operaciju kod " + SelectedLekar.Ime + " " + SelectedLekar.Prezime + " za " + datumNovi.ToString() + ".";
                        ...
                        TerminProzor tp = new TerminProzor(parent, jmbg);
                        MessageBox.Show("Uspesno ste pomerili operaciju.");
                        parent._mainFrame.NavigationService.Navigate(tp);
                    }
                }
            }
